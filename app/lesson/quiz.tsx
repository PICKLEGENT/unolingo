        ...
        return (
            <>
                ...
                <Confetti
                    ...
                    height={height}
                />
                <div className="flex flex-col justify-center items-center gap-y-4 lg:gap-y-8 max-w-lg mx-auto h-full">
                    <Image
                        src='/finish.svg'
                        alt='Finish'
                        width={100}
        ...
        <>
            ...
            <div className="flex-1">
                <div className="flex justify-center items-center h-full">
                    <div className="lg:min-h-[350px] lg:w-[600px] px-6 lg:px-0 flex flex-col gap-y-12 w-full">
